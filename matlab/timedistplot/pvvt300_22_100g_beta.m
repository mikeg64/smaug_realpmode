...
evelchrom_bet=zeros(nt,124);  %  horizontal section in chrom at  20
eveltran_bet=zeros(nt,124);   %  horizontal section in transition layer at 42
evelcor_bet=zeros(nt,124);    %  horizontal section in corona at 90

evel2Mm_bet=zeros(nt,124);  %vertical section at 2Mm  62
...
%    evelp5Mm_vh(i,:)=myval(15,31,:);  %vertical section at 0.5Mm 15
    ...
    evelchrom_bet(i,:)=mytval( 62,:,20);  %  horizontal section in chrom at  20
    eveltran_bet(i,:)=mytval( 62,:,42);   %  horizontal section in transition layer at 42
    evelcor_bet(i,:)=mytval( 62,:,90);    %  horizontal section in corona at 90

    evel2Mm_bet(i,:)=mytval(62,62,:);  %vertical section at 2Mm  62
