...
%energy flux
   ...
   eflux=eflux+(myval8.*myval11+myval9.*myval12+myval10.*myval13).*(myval5./myval4);
   eflux=eflux+(myval5.*myval8+myval6.*myval9+myval7.*myval10).*(myval11./myval4);
