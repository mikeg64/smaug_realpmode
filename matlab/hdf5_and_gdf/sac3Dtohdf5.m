...
%ndirectory='/fastdata/cs1mkg/smaug_wash/washmc_2p5_2p5_12p5_mach180_uni6/h5min/';

ndirectory='/shared/sp2rc2/Shared/simulations/smaug_realpmode/fastdata/cs1mkg/smaug/spic_5b2_2_bv100G/h5min';
...
%for i=1:50:1088
for i=[76 150 225 376 425 528]

id=int2str(1000*i);
sacfilename=[directory,'zerospic1__',id,extension];
%timetext=['time=',num2str(250*i/1000),'s'];
timetext=['time=',num2str(i/1000),'s'];
gdffilename=[ndirectory,'zerospic1_',id,nextension];
